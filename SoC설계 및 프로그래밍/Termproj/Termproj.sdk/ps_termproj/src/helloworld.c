...
int main(void)
{
	...
	PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG0_OFFSET, C);
	PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, 1);
	while(TRUE)
	{
		...
		if(mode == 0){
			...
			if(min==0x59 && (sec==0x57))
			{
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG0_OFFSET, C);
				temp = (int)(C/2);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, temp);
				sleep(1);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, 1);
			}
			else if(min==0x59 && sec==0x58)
			{
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG0_OFFSET, E);
				temp = (int)(E/2);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, temp);
				sleep(1);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, 1);
			}
			else if(min==0x59 && sec==0x59)
			{
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG0_OFFSET, G);
				temp = (int)(G/2);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, temp);
				sleep(1);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, 1);
			...
			{
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG0_OFFSET, B);
				temp = (int)(B/2);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, temp);
				sleep(1);
				PWM_GEN_mWriteReg(XPAR_PWM_GEN_0_S00_AXI_BASEADDR, PWM_GEN_S00_AXI_SLV_REG1_OFFSET, 1);
